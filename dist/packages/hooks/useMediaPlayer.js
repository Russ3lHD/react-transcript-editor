 ...
 */
export const useMediaPlayer = (options = {}) => {
    const { initialPlaybackRate = 1, initialVolume = 1, initialIsMuted = false, playbackRateOptions = DEFAULT_PLAYBACK_RATES, onTimeUpdate, onPlay, onPause, onEnded, onPlaybackRateChange, onVolumeChange, } = options;
    ...
    const increasePlaybackRate = useCallback(() => {
        const currentIndex = playbackRateOptions.findIndex(option => option.value === state.playbackRate);
...
//# sourceMappingURL=useMediaPlayer.js.map