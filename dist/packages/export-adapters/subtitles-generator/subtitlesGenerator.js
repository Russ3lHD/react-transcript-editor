...
function addTimecodesToLines(wordsList, lines) {
    ...
    const results = lines.map((line) => {
        ...
        const jsonLine = { text: line.trim(), start: 0, end: 0 };
...
function subtitlesComposer({ words, type, numberOfCharPerLine }) {
    const subtitlesJson = preSegmentTextJson(words, numberOfCharPerLine || 35);
...
//# sourceMappingURL=subtitlesGenerator.js.map